...
def map_page(request):
    ...
    for item in marker:
        ...
        folium.Marker(location=[location.latitude, location.longitude], popup=comm_str, icon=folium.Icon(color='green')).add_to(map)
...
def partners_page(request):
    return render(request=request, template_name='petonia_app/partners.html')
